	    ...
	    <div className="app-container">
	      ...
	      <header className="header">
	        ...
	        <nav className="nav-bar">
	          <button
	            className={currentTab === 'matches' ? 'active' : ''}
	            onClick={() => setCurrentTab('matches')}
	          >
	            Fixtures
	          </button>
	          <button
	            className={currentTab === 'standings' ? 'active' : ''}
	            onClick={() => setCurrentTab('standings')}
	          >
	            Groups
	          </button>
	          <button
	            className={currentTab === 'scorers' ? 'active' : ''}
	            onClick={() => setCurrentTab('scorers')}
	          >
	            Scorers
	          </button>
	          <button
	          ...
	          {user && (
	            <button
	              className={currentTab === 'watchlist' ? 'active' : ''}
	              onClick={() => { setCurrentTab('watchlist'); fetchWatchlist(); }}
	            >
	              ⭐ Watchlist
	            </button>
	          )}
	        ...
	        <div className="detail-view">
	          <div className="detail-card-full">
	            ...
	            <div className="detail-header">
	              ...
	              <p className="match-timestamp">
	                {selectedMatch.fixture?.date
	                  ? new Date(selectedMatch.fixture.date).toLocaleString([], {
	                      dateStyle: 'long',
	                      timeStyle: 'short'
	                    })
	                  : ""}
	            ...
	            <div className="scoreline-hero">
	              ...
	              <div className="score-display">
	                ...
	                {selectedMatch.score?.penalty?.home !== null && selectedMatch.score?.penalty?.home !== undefined && (
	                  <span className="pens-label">
	                    ({selectedMatch.score.penalty.home}-{selectedMatch.score.penalty.away} pens)
	                  </span>
	                )}
	              </div>
	              <div className="detail-team">
